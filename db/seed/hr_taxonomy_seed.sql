...
--    FIB+MCQ+SJR minimums for that competency from the Directions sheet ─────
INSERT INTO hr_competency (code, assessment_id, skill_category_id, name, min_random_selection) VALUES
  ...
  ($qb$A1-05$qb$, 1, 2, $qb$Supervisor & Alignment Management$qb$, 3),
  ...
  ($qb$A1-09$qb$, 1, 2, $qb$Workplace & Change Adaptation$qb$, 4),
  ($qb$A2-01$qb$, 2, 3, $qb$First-Principles Thinking$qb$, 5),
  ...
  ($qb$A2-06$qb$, 2, 4, $qb$Problem Identification & Innovation$qb$, 5),
  ...
  ($qb$A4-01$qb$, 4, 6, $qb$Egoless & Accountability Mindset$qb$, 4),
  ($qb$A4-02$qb$, 4, 6, $qb$Ethical Working & Professional Integrity$qb$, 4),
  ($qb$A4-03$qb$, 4, 6, $qb$Inclusivity & Equal Opportunity Orientation$qb$, 5),
  ...
  ($qb$A4-06$qb$, 4, 7, $qb$Business Storytelling & Narrative Building$qb$, 4),
  ($qb$A4-07$qb$, 4, 7, $qb$Feedback Receptivity & Delivery$qb$, 4),
  ($qb$A5-01$qb$, 5, 8, $qb$Delegation & Empowerment$qb$, 5),
  ($qb$A5-02$qb$, 5, 8, $qb$People Management & Coaching$qb$, 5),
  ($qb$A5-03$qb$, 5, 8, $qb$Stakeholder Management$qb$, 5),
  ($qb$A5-04$qb$, 5, 8, $qb$Vision & Strategic Alignment$qb$, 5),
  ($qb$A5-05$qb$, 5, 9, $qb$Cross-Functional Silo-Busting$qb$, 5),
  ($qb$A5-06$qb$, 5, 9, $qb$Psychological Safety Creation$qb$, 5),
  ...
  ($qb$A7-01$qb$, 7, 11, $qb$Execution & Closure Focus$qb$, 5),
  ($qb$A7-02$qb$, 7, 11, $qb$Precision & Written Documentation$qb$, 4),
  ($qb$A7-03$qb$, 7, 11, $qb$Proactive Strategic Planning$qb$, 4),
  ($qb$A7-04$qb$, 7, 11, $qb$Resourcefulness & Operational Ingenuity$qb$, 4),
  ($qb$A7-05$qb$, 7, 11, $qb$Time Management & Punctuality$qb$, 4),
  ($qb$A7-06$qb$, 7, 12, $qb$Attention & Focus Management$qb$, 5),
  ($qb$A7-07$qb$, 7, 12, $qb$Energy Management & Burnout Prevention$qb$, 4)
